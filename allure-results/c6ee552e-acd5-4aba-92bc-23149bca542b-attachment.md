...
Call log:
  - waiting for locator('//div[@class="plp-filter-bar__options"]//button[1]')

    at ProductPage.sortByMostPopular (C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\pages\productPage.js:50:61)
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:47:31
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:46:20
```
...
- main:
  ...
  - text: Available for delivery Back in Hyderabad in 1 week
  ...
  - group "More options NYHAMN":
    ...
    - 'radio "Option: NYHAMN 3-seat sofa-bed, with foam mattress/Naggen beige"'
    - 'link "Option: NYHAMN 3-seat sofa-bed, with foam mattress/Naggen beige"':
      - /url: https://www.ikea.com/in/en/p/nyhamn-3-seat-sofa-bed-with-foam-mattress-naggen-beige-s49499984/
    - 'radio "Option: NYHAMN 3-seat sofa-bed, with pocket spring mattress/Naggen beige"'
    - 'link "Option: NYHAMN 3-seat sofa-bed, with pocket spring mattress/Naggen beige"':
      - /url: https://www.ikea.com/in/en/p/nyhamn-3-seat-sofa-bed-with-pocket-spring-mattress-naggen-beige-s19494624/
  ...
  - link "KIVIK 3-seat sofa with chaise longue, Kelinge grey-turquoise":
  ...
  - link "KIVIK 4-seat sofa with chaise longue, Kelinge grey-turquoise":
  ...
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 3-seat sofa with chaise longue, Tibbleby beige/grey":
  ...
  - button "Save \"KIVIK 3-seat sofa with chaise longue\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 2-seat sofa, Tibbleby beige/grey":
  ...
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 2-seat sofa, Kelinge grey-turquoise":
  ...
  - button "Save \"KIVIK 2-seat sofa\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 3-seat sofa, Kelinge grey-turquoise":
    - /url: https://www.ikea.com/in/en/p/kivik-3-seat-sofa-kelinge-grey-turquoise-s19443050/
  ...
  - button "Save \"KIVIK 3-seat sofa\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 4-seat sofa with chaise longue, Tibbleby beige/grey":
  ...
  - link "KIVIK 3-seat sofa with chaise longue, Tresund anthracite":
  ...
  - button "Save \"KIVIK 3-seat sofa with chaise longue\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 4-seat sofa with chaise longue, Tresund light beige":
  ...
  - link "KIVIK 3-seat sofa, Tresund light beige":
    - /url: https://www.ikea.com/in/en/p/kivik-3-seat-sofa-tresund-light-beige-s49482832/
  ...
  - button "Save \"KIVIK 3-seat sofa\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 3-seat sofa, Tibbleby beige/grey":
    - /url: https://www.ikea.com/in/en/p/kivik-3-seat-sofa-tibbleby-beige-grey-s59440592/
  ...
  - button "Save \"KIVIK 3-seat sofa\" to shopping list"
  - text: Available for delivery Out of stock in Hyderabad Medium firm
  - link "KIVIK 2-seat sofa, Tresund light beige":
  ...
  - button "Save \"KIVIK 2-seat sofa\" to shopping list"
  - text: Available for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 3-seat sofa with chaise longue, Tresund light beige":
  ...
  - button "Save \"KIVIK 3-seat sofa with chaise longue\" to shopping list"
  - text: Currently unavailable for delivery In stock in Hyderabad Medium firm
  - link "KIVIK 2-seat sofa, Tresund anthracite":
...
> 50 |         await this.page.locator(productLocators.sortButton).click();
  ...
  52 |         await this.page.locator(productLocators.sortButton).click();
  53 |
  54 |         await this.waitForTimeout(2000);
  55 |
  56 |         const sortedProducts = await this.page.$$eval(productLocators.productTitle, elements => elements.map(el => el.innerText));
  57 |         expect(sortedProducts.length).toBeGreaterThan(0); // Ensure sorted products are displayed
  58 |     }
  59 |
  60 |     /**  **Filtering Operations** **/
  61 |     async extractWardrobes() {
  62 |         // expect(await this.page.locator(productLocators.categoryDropdown).isVisible()).toBeTruthy();
  63 |         // expect(await this.page.locator(productLocators.storageFilter).isVisible()).toBeTruthy();
  64 |         // expect(await this.page.locator(productLocators.materialFilter).isVisible()).toBeTruthy();
  65 |         // expect(await this.page.locator(productLocators.metalFilter).isVisible()).toBeTruthy();
  66 |
  67 |         await this.page.locator(productLocators.categoryDropdown).click();
  68 |         await this.page.waitForTimeout(2000)
  69 |         await this.page.locator(productLocators.storageFilter).click();
  70 |         await this.waitForTimeout(2000);
  71 |
  72 |         await this.page.locator(productLocators.materialFilter).click();
  73 |         await this.page.locator(productLocators.metalFilter).click();
  74 |         await this.waitForTimeout(2000);
  75 |
  76 |         const productNames = await this.page.$$eval(productLocators.productTitle, elements => elements.map(el => el.innerText));
  77 |
  78 |         expect(productNames.length).toBeGreaterThan(0); // Ensure wardrobes exist
  79 |
  80 |         let wardrobeData = [];
  81 |         for (let i = 0; i < productNames.length && i < 20; i++) {
  82 |             wardrobeData.push({
  83 |                 name: productNames[i]
  84 |             });
  85 |         }
  86 |
  87 |         return wardrobeData;
  88 |     }
  89 | }
  90 |
  91 | export default ProductPage;
  92 |
```
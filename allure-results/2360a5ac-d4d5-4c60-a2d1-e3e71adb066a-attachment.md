...
Call log:
  - waiting for locator('input[id="discount-code__error"]')
    ...
    at CartPage.discount (C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\pages\cartpage.js:49:80)
...
- main:
  - main:
    ...
    - list:
      ...
      - listitem: Available for Click & Collect
    - link "RINNIG ART":
      - /url: https://www.ikea.com/in/en/p/-80476348
      - img "RINNIG ART"
    - link "RINNIG":
      - /url: https://www.ikea.com/in/en/p/-80476348
    - text: Tea towel, white/dark grey/patterned, 45x60 cm, 4 pack/pack Rs. 199
...
```ts
  ...
  48 |
> 49 |         console.log(await this.page.locator(cartLocators.discountErrorMessage).innerText())
     |                                                                                ^ Error: locator.innerText: Test timeout of 30000ms exceeded.
  50 |
  51 |     }
  52 | }

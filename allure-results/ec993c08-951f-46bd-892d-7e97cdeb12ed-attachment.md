...
- Location: C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:46:9
...
Received: false
    at Homepage.setPincode (C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\pages\homepage.js:27:85)
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:19:13
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:18:9
```
...
```ts
   ...
   2 | import { expect } from '@playwright/test';  // Import Playwright assertions
   3 |
   4 | class Homepage {
   5 |     constructor(page) {
   6 |         this.page = page;
  ...
  17 |         expect(elementHandle).not.toBeNull();  // Ensure the element exists before attempting highlight
  18 |         
...
> 27 |         expect(await this.page.locator(homepageLocators.pincodeButton).isVisible()).toBeTruthy();  // Ensure pincode button is visible
     |                                                                                     ^ Error: expect(received).toBeTruthy()
  28 |
  ...
  32 |
  33 |         expect(await this.page.locator(homepageLocators.pincodeInput).isVisible()).toBeTruthy();  // Ensure pincode input is visible
  34 |
  ...
  37 |
  38 |         expect(await this.page.locator(homepageLocators.confirmPincode).isVisible()).toBeTruthy();  // Ensure confirm button is visible
  39 |
  ...
  49 |
  50 |         expect(await this.page.locator(homepageLocators.searchButton).isVisible()).toBeTruthy();  // Ensure search button is visible
  51 |

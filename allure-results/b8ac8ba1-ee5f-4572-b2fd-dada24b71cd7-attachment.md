...
Call log:
  ...
  - waiting for locator('a[aria-label="Enter postal code"]')
    ...
    at Homepage.setPincode (C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\pages\homepage.js:27:73)
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:34:28
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:33:20
```
...
- main:
  - article:
    ...
    - button "See previous items"
    - button "See next items"
    - button "Load 6 moreLoading…" [disabled]

...
- Location: C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:69:9
...
Call log:
  ...
  - waiting for locator('//div[@class="search-box-wrapper"]//button[@type="submit"]')
    ...
    at Homepage.searchProduct (C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\pages\homepage.js:50:72)
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:71:13
    at C:\Users\2397826\OneDrive - Cognizant\Documents\Final Hackathon\tests\main.spec.js:70:9
```
...
- banner:
  ...
  - search:
    - combobox "Search for products, inspiration or new arrivals" [expanded]
    - button "Search IKEA products using a photo"
  - dialog "Search suggestions":
    - paragraph: Search IKEA products using a photo
    - button "Close"
    - list "Search suggestions":
      - listitem:
        - link "mirror":
          - /url: https://www.ikea.com/in/en/search/?q=mirror
          - paragraph: mirror
      - listitem:
        - link "chair":
          - /url: https://www.ikea.com/in/en/search/?q=chair
          - paragraph: chair
      - listitem:
        - link "shoe rack":
          - /url: https://www.ikea.com/in/en/search/?q=shoe rack
          - paragraph: shoe rack
      - listitem:
        - link "Beds with storage":
          - /url: https://www.ikea.com/in/en/cat/beds-with-storage-25205/
          - paragraph: Beds with storage
      - listitem:
        - link "Home and office desks":
          - /url: https://www.ikea.com/in/en/cat/desks-for-home-20651/
          - paragraph: Home and office desks
      - listitem:
        - link "Bookshelves and Bookcases":
          - /url: https://www.ikea.com/in/en/cat/bookcases-10382/
          - paragraph: Bookshelves and Bookcases
      - listitem:
        - link "Chest of drawers":
          - /url: https://www.ikea.com/in/en/cat/chests-of-drawers-10451/
          - paragraph: Chest of drawers
  - navigation:
    - button "Hej! Log in"
    - link "Shopping list":
...
```ts
  ...
  32 |
  33 |         await expect(this.page.locator(homepageLocators.pincodeInput)).toBeVisible()
  34 |
  35 |         await this.highlightElement(homepageLocators.pincodeInput);
  36 |         await this.page.locator(homepageLocators.pincodeInput).fill(pincode);
  37 |
  38 |         await expect(this.page.locator(homepageLocators.confirmPincode)).toBeVisible()
  39 |
  40 |         await this.page.locator(homepageLocators.confirmPincode).click();
  41 |     }
  42 |
  43 |     /**  **Search Product** **/
  44 |     async searchProduct(productName) {
  45 |
  46 |         await this.highlightElement(homepageLocators.searchInput);
  47 |         await this.page.locator(homepageLocators.searchInput).fill(productName);
  48 |         await this.waitForTimeout();
  49 |
> 50 |         await expect(this.page.locator(homepageLocators.searchButton)).toBeVisible();  // Ensure search button is visible
     |                                                                        ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  51 |
  52 |         await this.highlightElement(homepageLocators.searchButton);
  53 |         await this.page.locator(homepageLocators.searchButton).click();
  54 |     }
  55 | }
  56 |

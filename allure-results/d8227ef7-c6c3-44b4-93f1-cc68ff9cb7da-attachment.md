...
- main:
  ...
  - button "Price"
  - button "Type"
  - button "Available for click and collect at Hyderabad"
  - button "Colour"
  - button "Category" [expanded]
  - button "All filters"
  - button "Back to Category"
  - text: Storage solution systems
  - list:
    - listitem:
      - button "PAX wardrobes with doors 28"
    - listitem:
      - button "SKYTTA sliding door combinations 3"
